...
describe('RegisterForm', () => {
	...
	it('should validate South African phone number format', async () => {
		...
		await waitFor(() => {
			// Should display the error in the component
			expect(
				screen.getByText(/Please enter a valid South African phone/i)
			).toBeInTheDocument();
		});
	...
	it('should accept valid South African phone numbers', async () => {
		mockRegister.mockResolvedValueOnce({});
		renderComponent();

		const validNumbers = ['012-345-6789', '071 234 5678', '+27 12 345 6789'];
